    ...
    return (
        <section className='grid grid-cols-8 md:grid-cols-16 gap-y-0 w-full bg-linear-to-b from-[#151515] to-[#101010] text-[#C1C1C1] font-neulisneue font-light text-base md:text-xl'>
            ...
            <div className="col-span-full flex flex-col">
                <DivAnimation className="relative col-span-full flex max-md:flex-col md:justify-center gap-24 md:py-36 md:pl-24 bg-black/30 border border-white/10 rounded-[30px_30px_0px_0px] custom-scrollbar">
