    ...
    return (
        <section className='grid grid-cols-8 md:grid-cols-16 gap-y-0 w-full bg-primary-100 text-neutral-500 font-albert font-normal text-base md:text-xl'>
                    ...
                    <div className="flex flex-col gap-12">
                        <div className={`${isMobile ? 'flex-col items-start gap-8' : ''} flex w-full items-center justify-between`}>
                            <div className="flex md:flex-row md:gap-4 flex-col justify-start">
                                <h1 className="text-5xl text-neutral-900 font-normal tracking-tight">Website Revamp</h1>
                    ...
                    <DivAnimation className="flex flex-col gap-6 w-full pb-9 border-b border-neutral-100">
                        <div className="flex flex-col w-full gap-5 md:gap-8">
                            ...
                            <HashLink to="#research" smooth className="flex gap-4 cursor-pointer ">
                                <h1 className="text-[2em] text-neutral-900">Iterations</h1>
                            </HashLink>
                        </div>
            ...
            <div className="col-span-full flex flex-col">
                <DivAnimation className="relative col-span-full flex max-md:flex-col md:justify-center gap-24 md:py-36 md:pl-24 bg-primary-100 border border-neutral-100 rounded-[30px_30px_0px_0px] custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 max-md:pb-12 max-md:p-10 max-w-md md:h-screen -top-8 md:top-32 sticky max-md:bg-primary-100 rounded-[30px_30px_0px_0px]">
                        ...
                        <div className="flex flex-col pt-5 md:pt-9 gap-4 md:gap-8 border-t border-neutral-100">
                            <h1 className="font-medium text-[1.5em] md:text-[2em] text-neutral-900">Landing Page</h1>
                    ...
                    <div className="flex flex-col w-full gap-4 custom-scrollbar max-md:overflow-hidden">
                        <img className="w-full border-2 border-neutral-100 rounded-[16px]" src={img1} />
                    </div>
                </DivAnimation>
                <DivAnimation className="relative col-span-full flex max-md:flex-col md:justify-center gap-24 md:py-36 md:pl-24 bg-primary-100 border border-neutral-100 custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 max-md:pb-12 max-md:p-10 max-w-md md:h-screen -top-8 md:top-32 sticky max-md:bg-primary-100">
                        <h3 className="text-neutral-500">HiFi Screens</h3>
                        <div className="flex flex-col pt-5 md:pt-9 gap-4 md:gap-8 border-t border-neutral-100">
                            <h1 className="font-medium text-[1.5em] md:text-[2em] text-neutral-900">Institutions Page</h1>
                            <p className="max-md:text-sm text-lg">
                    ...
                    <div className="flex flex-col w-full gap-4 custom-scrollbar max-md:overflow-hidden">
                        <img className="w-full border-2 border-neutral-100 rounded-[16px]" src={INSTITUTIONS} />
                ...
                <DivAnimation className="relative col-span-full flex max-md:flex-col md:justify-center gap-24 md:py-36 md:pl-24 bg-primary-100 border border-neutral-100 custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 max-md:pb-12 max-md:p-10 max-w-md md:h-screen -top-8 md:top-32 sticky max-md:bg-primary-100">
                        <h3 className="text-neutral-500">HiFi Screens</h3>
                        <div className="flex flex-col pt-5 md:pt-9 gap-4 md:gap-8 border-t border-neutral-100">
                            <h1 className="font-medium text-[1.5em] md:text-[2em] text-neutral-900">Subscriber Home</h1>
                            <p className="max-md:text-sm text-lg">
                    ...
                    <div className="flex flex-col w-full gap-4 custom-scrollbar max-md:overflow-hidden">
                        <img className="w-full border-2 border-neutral-100 rounded-[16px]" src={SUBHOME} />
