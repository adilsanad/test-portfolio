...
const Pagr = ({ isMobile }: { isMobile: boolean }) => {
    return (
        <section className={` grid grid-cols-8 md:grid-cols-16 gap-y-20 md:gap-y-24 w-full bg-primary-100 text-neutral-500 font-albert font-normal text-base md:text-xl`}>
            ...
            <DivAnimation id="research" className="col-span-full max-md:px-6 md:col-span-10 md:col-start-4 flex flex-col gap-10 pt-20 border-t border-neutral-100">
                <h1 className="font-bold text-[2em] text-neutral-900">User Profiles</h1>
            ...
            <DivAnimation className="col-span-full">
                <PersonaScroll isMobile={isMobile} personas={personaData} theme="light" />
            </DivAnimation>
            <DivAnimation id="wireframing" className="col-span-full max-md:px-6 md:col-span-10 md:col-start-4 flex flex-col gap-10 pt-20 border-t border-neutral-100">
                <h1 className="font-bold text-[2em] text-neutral-900">Wireframing</h1>
            ...
            <DivAnimation className="col-span-full mx-6 px-4 md:px-42 rounded-[30px] bg-primary-200 flex justify-center gap-6 overflow-x-auto custom-scrollbar">
                <img className="w-full" src={WIREFRAMES}></img>
            </DivAnimation>
            <DivAnimation className="col-span-full max-md:px-6 md:col-span-10 md:col-start-4 flex flex-col gap-10 pt-20 border-t border-neutral-100">
                <h1 className="font-bold text-[2em] text-neutral-900">Styling</h1>
            ...
            <DivAnimation className="col-span-full flex flex-col gap-32 md:items-center">
                ...
                <div className="flex max-md:flex-col max-md:p-6 gap-9 md:gap-11 md:items-center max-md:text-5xl text-[3rem]">
                    ...
                    <div className="flex max-md:flex-col md:items-center max-md:text-4xl gap-6 md:gap-9 font-light">
                        ...
                        <p className="text-neutral-500">Red Hat Text</p>
                    </div>
                </div>
            </DivAnimation>
            <div id="finalscreens" className="col-span-full grid grid-cols-4 md:grid-cols-16 max-md:gap-y-8 flex-col bg-primary-200 ">
                <div className="relative col-span-full flex flex-col md:justify-center max-md:items-center pag-12 md:gap-28 md:py-36 bg-white border border-neutral-100 rounded-[30px_30px_0px_0px] custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 md:px-24 max-md:pb-12 max-md:p-10 max-md:bg-primary-100 rounded-[30px_30px_0px_0px]">
                        <h3 className="text-neutral-500">HiFi Screens</h3>
                        <div className="flex max-md:flex-col pt-5 md:pt-9 gap-4 md:gap-2 border-t border-neutral-100">
                            <h1 className="font-medium leading-8 md:leading-12 text-[1.5em] md:text-[2em] md:min-w-xl pr-8 text-neutral-900">Home Page, Search & Business Pages</h1>
                ...
                <div className="relative col-span-full flex max-md:flex-col md:justify-center md:gap-0 md:py-36  bg-white border border-neutral-100 custom-scrollbar overflow-hidden">
                    <div className="flex flex-col w-full md:h-full md:justify-between md:py-12 max-md:pb-5 items-end">
                        <div className="flex flex-col gap-3 max-md:py-18 md:px-24 max-md:pb-12 max-md:p-10  max-md:bg-primary-100">
                            <h3 className="text-neutral-500">HiFi Screens</h3>
                            <div className="flex flex-col pt-5 md:pt-9 gap-4 md:gap-8 border-t border-neutral-100">
                                <h1 className="font-medium text-[1.5em] md:text-[2em] text-neutral-900">Map View</h1>
                ...
                <div className="relative col-span-full flex flex-col md:justify-center max-md:items-center gap-28 md:py-36 bg-white border border-neutral-100 rounded-[30px_30px_0px_0px] custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 md:px-24 max-md:pb-12 max-md:p-10 max-md:bg-primary-100 rounded-[30px_30px_0px_0px]">
                        <h3 className="text-neutral-500">HiFi Screens</h3>
                        <div className="flex max-md:flex-col pt-5 md:pt-9 gap-4 md:gap-0 border-t border-neutral-100">
                            <h1 className="font-medium leading-12 text-[1.5em] md:text-[2em] md:min-w-lg pr-8 text-neutral-900">Community Features</h1>
                ...
                <div className="relative col-span-full flex max-md:flex-col md:justify-center gap-24 md:py-36 md:pl-24 bg-white border border-neutral-100 custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 max-md:pb-12 max-md:p-10 max-w-md md:h-screen -top-8 md:top-32 md:sticky max-md:bg-primary-100">
                        <h3 className="text-neutral-500">HiFi Screens</h3>
                        <div className="flex flex-col pt-5 md:pt-9 gap-4 md:gap-8 border-t border-neutral-100">
                            <h1 className="font-medium text-[1.5em] md:text-[2em] text-neutral-900">Filters</h1>
                ...
                <div className="relative col-span-full flex flex-col md:justify-center max-md:items-center gap-24 md:py-36 bg-white border border-neutral-100 rounded-[30px_30px_0px_0px] custom-scrollbar">
                    <div className="flex flex-col gap-3 max-md:py-18 md:px-24 max-md:pb-12 max-md:p-10 max-md:bg-primary-100 rounded-[30px_30px_0px_0px]">
                        <h3 className="text-neutral-500">HiFi Screens</h3>
                        <div className="flex max-md:flex-col pt-5 md:pt-9 gap-4 md:gap-0 border-t border-neutral-100">
                            <h1 className="font-medium leading-12 text-[1.5em] md:text-[2em] md:min-w-lg pr-8 text-neutral-900">Community Features</h1>
