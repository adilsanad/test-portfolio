  ...
  return (
    <div className="grid grid-cols-8 md:grid-cols-16 w-full bg-[#0B0B0B]">
      ...
      <div className="col-span-full flex justify-center items-center gap-4 py-32">
        ...
        <svg className="hover:rotate-60 active:rotate-60 transition-all" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="hover:-rotate-60 active:rotate-60 transition-all" width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
